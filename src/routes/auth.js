...
//   const signupJsonSchema = joiToJsonSchema(signupSchema);
//   const loginJsonSchema = joiToJsonSchema(loginSchema);
...
//       response: {
//         201: { description: 'User created successfully', type: 'object', properties: { user: { type: 'object' } } },
...
//       response: {
//         200: { description: 'Login successful', type: 'object', properties: { token: { type: 'string' }, user: { type: 'object' } } },
